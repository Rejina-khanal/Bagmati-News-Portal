<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/bibidh.css') }}">
...
@section('section')
    ...
    <body>
        ...
        <div class="business_body_section">
                    ...
                    <div class="col-8 col-sm-9 col-md-9 col-lg-9 col-xl-9 col-xxl-9">
                        <div class="bank_section">
                            ...
                            <div class="business_news_heading">
                                <h3>रन्जन कोइरालाको मुद्दा फैसलाबारे चोलेन्द्रको बयान : मलाई प्रायश्चित छ</h3>
                                <hr class="business_line">
                                <h3>लुम्बिनी प्रदेश सरकारले विपद्‍मा परेका नागरिकको हवाई उद्धार गर्ने, कसरी लिने सेवा ?</h3>
                                <hr class="business_line">
                            </div>
                            <!--Bibid main news heading end-->

                            <!--Main Bibid news section-->
            ...
            <!--news, advertisement and market section end-->

            <!--Paryatan news section start-->
            <section class="paryatan_body">
                <div class="heading">
                    <h1 class="line">पर्यटन</h1>
                    <div class="line blue_line one"></div>
                </div>
                <div class="row">
            ...
            <!--Paryatan news section end-->

            <!--Rojgar news section start-->
            <section class="rojgar_body">
                <div class="heading">
                    <h1 class="line">रोजगार</h1>
                    <div class="line blue_line one"></div>
                </div>
                <div class="row">
            ...
            <!--Pradesh news section start-->
            <section class="rojgar_body">
                <div class="heading">
                    <h1 class="line">प्रदेश समाचार</h1>
                    <div class="line blue_line one"></div>
                </div>
                <!--Pradesh samachar main news section start-->
                <div class="businesss_main_news">
                    <div class="card">
                        <div class="row">
                            <div class="col-6">
                                <a href="">
                                    <img src="{{ asset('assets/images/businesss.jpg') }}" alt="Avatar"> </a>
                            </div>
                            <div class="col-6 ">
                                <div class="businesss_main_news_detail">
                                    <h3>
                                        कति छ आज सुन चाँदीको मूल्य ?
                                    </h3>
                                    <p>३ भाद्र २०७९, शुक्रबार</p>
                ...
                <!--Pradesh samachar main news section end-->
                ...
                <!--Pradesh other news section end-->
            </section>
            <!--Pradesh news section end-->
        </div>
    </body>
@endsection
